...
while True:
    ...
    if opcion.decode("utf-8") == 'ls':   # el cliente elige listar el directorio del servidor
        ...
        lista = pickle.dumps(listaFichero)  # envío de la lista de ficheros
    ...
    if opcion.decode("utf-8") == 'rm':  # el cliente elige borrar un fichero del directorio del servidor
        ...
        try:
            ...
            s_udp.sendto("El fichero ha sido borrado con éxito".encode("utf-8"), addrCliente)
            ...
            s_udp.sendto("Algo salió mal.".encode("utf-8"), addrCliente)
    ...
    if opcion.decode("utf-8") == 'write':   # el cliente elige crear un fichero 
        ...
        try:
            ...
            s_udp.sendto("El fichero ha sido creado con éxito".encode("utf-8"), addrCliente)
        except:
            s_udp.sendto("Algo salió mal".encode("utf-8"), addrCliente)
        finally:
            f.close()
    ...
    if opcion.decode("utf-8") == 'cd':  # el cliente elige cambiar el directorio del servidor
        ...
        try:
            ...
            s_udp.sendto("El cambio de directorio ha sido realizado con éxito".encode("utf-8"), addrCliente)
    ...
    if opcion.decode("utf-8") == 'mv':  # el cliente elige mover un fichero
        ...
        try:
            ...
            s_udp.sendto("La operación ha sido realizada con éxito".encode("utf-8"), addrCliente)
        except:
            s_udp.sendto("Algo salió mal".encode("utf-8"), addrCliente)
